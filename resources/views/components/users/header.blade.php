...
<body  class="total-number-variant date-picker">
  <div class="wrapper">
    ...
    <div class="preload preload-container">
      <div class="middle">
        <div class="img-preload">
          <div class="img">
            <img
              src="image/page-title/page-title-home-2-2.png"
              alt=""
              class="lazyload"
            />
          </div>
      ...
      <div class="top-bar-inner">
        ...
        <div class="top-bar-right top-bar-content">
          ...
          <span class="location">
            ...
            267 Lê Thị Riêng, Quận 12, TP Hồ Chí Minh
          </span>
        </div>
      </div>
    </div>
    ...
    <header id="header_main" class="header header-fixed">
      <div class="header-inner style-3">
        <div class="header-inner-wrap">
          ...
          <div class="logo">
            <a href="index-2.html">
              <img
                src="image/logo/logo-black.svg"
                data-src="image/logo/logo-black.svg"
                alt=""
                class="lazyload"
              />
            </a>
                  ...
                  <div class="wg-language">
                    ...
                    <div class="language-list">
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/united-kingdom.png"
                            data-src="image/country/united-kingdom.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/china.png"
                            data-src="image/country/china.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/japan.png"
                            data-src="image/country/japan.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/germany.png"
                            data-src="image/country/germany.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/portugal.png"
                            data-src="image/country/portugal.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/france.png"
                            data-src="image/country/france.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/Spain.png"
                            data-src="image/country/Spain.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/italy.png"
                            data-src="image/country/italy.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/south-korea.png"
                            data-src="image/country/south-korea.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/vietnam.png"
                            data-src="image/country/vietnam.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                  ...
                  <div class="wg-currency">
                    ...
                    <div class="currency-list">
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/european-union.png"
                            data-src="image/country/european-union.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/usa.png"
                            data-src="image/country/usa.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/singapore.png"
                            data-src="image/country/singapore.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/hong_kong.png"
                            data-src="image/country/hong_kong.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                    ...
                    <div class="currency-list">
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/united-arab-emirates.png"
                            data-src="image/country/united-arab-emirates.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/switzerland.png"
                            data-src="image/country/switzerland.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/mongolia.png"
                            data-src="image/country/mongolia.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/new-zealand.png"
                            data-src="image/country/new-zealand.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/thailand.png"
                            data-src="image/country/china.png"
                            alt=""
                            class="lazyload"
                          />
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/sweden.png"
                            data-src="image/country/sweden.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/australia.png"
                            data-src="image/country/sweden.png"
                            alt=""
                            class="lazyload"
                          />
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/mexico.png"
                            data-src="image/country/mexico.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/philippine.png"
                            data-src="image/country/philippine.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/turkey.png"
                            data-src="image/country/turkey.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/brazil.png"
                            data-src="image/country/brazil.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/indonesia.png"
                            data-src="image/country/indonesia.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/flat.png"
                            data-src="image/country/flat.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/poland.png"
                            data-src="image/country/poland.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/taiwan.png"
                            data-src="image/country/taiwan.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/canada.png"
                            data-src="image/country/canada.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/india.png"
                            data-src="image/country/india.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/Malaysia.png"
                            data-src="image/country/Malaysia.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      ...
                      <a href="#" class="language-item">
                        <div class="icon">
                          <img
                            src="image/country/russia.png"
                            data-src="image/country/russia.png"
                            alt=""
                            class="lazyload"
                          />
                        </div>
        ...
        <div class="inner-mobile-nav">
          ...
          <nav class="mobile-main-nav">
            <ul id="menu-mobile" class="menu">
              <li
                class="menu-item current-item-mobile"
              >
                <a
              ...
              <li class="menu-item menu-item-has-children-mobile">
                ...
                <ul
                  id="dropdown-menu-2"
                  class="sub-menu-mobile collapse"
                  data-bs-parent="#menu-mobile"
                >
                  <li class="menu-item menu-item-has-children-mobile2">
                    <a
                      href="#sub-product-1"
                      class="fw-6 text-body-3 item-menu-mobile collapsed"
                      data-bs-toggle="collapse"
                      >Layout</a
                    >
                    <ul
                      id="sub-product-1"
                      class="sub-menu-mobile2 collapse"
                      data-bs-parent="#dropdown-menu-2"
                    >
                      <li class="menu-item">
                        <a href="listing-tours-pagination.html"
                          >Grid Style – Full Width</a
                      ...
                      <li class="menu-item">
                        <a href="listing-tours-pagination-2.html"
                          >List Style – Full Width</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li
                    class="menu-item menu-item menu-item-has-children-mobile2"
                  >
                    <a
                      href="#sub-product-2"
                      class="fw-6 text-body-3 item-menu-mobile collapsed"
            ...
            <ul id="contact-us-mobile" class="menu">
              <li class="menu-item text-body-2 fw-6">Welcome to Epictrips</li>
              <li>
                <div class="details-section">
                  <div class="phone details-content pb-10">
                    ...
                    <div
                      class="sub-title text-body-3 numberphone wow fadeInUp"
                    >
                      +1 666 234 8888
                    </div>
                  </div>
                  <div class="email details-content pb-10">
                    ...
                    <div
                      class="sub-title text-body-3 address-email wow fadeInUp"
                    >
                      themeflat@gmail.com
                    </div>
                  </div>
