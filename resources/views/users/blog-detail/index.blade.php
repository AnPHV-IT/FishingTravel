@extends('layouts.app')
@section('title',' Travel | Blog Detail')
@section('content')
<body  class="loadmore">
    <div id="wrapper">
              <!-- Main-content -->
            ...
            <div class="col-lg-8">
              ...
              <div class="blog-details tf-spacing-2">
                <div class="btn-top">
                  ...
                  <a
                    class="tf-btn style-uppercase style-2 wow fadeInUp"
                    data-wow-delay="0.1s"
                  >
                    SEA
                  </a>
                ...
                <h3 class="title wow fadeInUp">
                  Discover the Best Sights and Experiences in Iconic
                ...
                <div class="tags pb-40">
                  <div class="tags-content wow fadeInUp">
                    <div class="frame">
                      ...
                      <div class="text-body-3 text">By David</div>
                    </div>
                    <div class="line"></div>
                    <div class="frame">
                      <div class="icon">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M12.834 1.66602V4.99935"
                            stroke="#121212"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M6.16602 1.66602V4.99935"
                            stroke="#121212"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                      ...
                      <div class="text-body-3 text">February 28, 2024</div>
                    </div>
                  </div>
                  <div class="tags-content wow fadeInUp" data-wow-delay="0.1s">
                    <div class="frame">
                      ...
                      <div class="text-body-3 text">12</div>
                    </div>
                    <div class="line"></div>
                    <div class="frame">
                      <div class="icon">
                      ...
                      <div class="text-body-3 text">260.2K</div>
                    </div>
                    <div class="line"></div>
                    <div class="frame">
                      <div class="icon">
                      ...
                      <div class="text-body-3 text">5 Min Read</div>
                    </div>
                  </div>
                </div>
                <div class="image hover-img">
                  <img
                    src="image/blog/blog-defaults-1.jpg"
                    data-src="image/blog/blog-defaults-1.jpg"
                    alt=""
                    class="lazyload"
                  />
                </div>
                <div class="content">
                  <div class="text text-body-2">
                    Traveling around the world offers endless opportunities to
                    explore diverse cultures, stunning landscapes, and
                    historical landmarks. In this article, we will take you on a
                    journey through some of the most iconic destinations around
                    the globe, highlighting the best sights and experiences each
                    has to offer. Whether you’re an adventure seeker, a history
                    buff, or a nature lover, these destinations have something
                ...
                <div class="cape-town">
                  ...
                  <ul>
                    <li class="text-body-2">
                      Table Mountain: Take a cable car to the top for stunning
                      views of the city and coastline.
                    </li>
                    <li class="text-body-2">
                      Robben Island: Visit the prison where Nelson Mandela was
                      held and learn about South Africa’s history.
                    </li>
                  </ul>
                </div>
                <div class="wg-quote">
                  <h4 class="fw-6">
                    "Uncover iconic destinations where unforgettable sights and
                    experiences await."
                  </h4>
                ...
                <div class="image-blog-post">
                  <div class="image-item hover-img">
                    <img
                      src="image/blog/image-blog-post-1.jpg"
                      data-src="image/blog/image-blog-post-1.jpg"
                      alt=""
                      class="lazyload"
                    />
                  </div>
                  <div class="image-item hover-img">
                    <img
                      src="image/blog/image-blog-post-2.jpg"
                      data-src="image/blog/image-blog-post-2.jpg"
                      alt=""
                      class="lazyload"
                    />
                  </div>
                ...
                <div class="wg-conclusion">
                  ...
                  <div class="text-body-2 text">
                    From the romantic streets of Paris to the vibrant cityscape
                    of Sydney, the world is full of iconic destinations waiting
                    to be explored. Each location offers its own unique sights
                    and experiences that make it special. Whether you're
                    planning your next big adventure or simply dreaming of
                    far-off places, let these destinations inspire your travel
                    plans and fill your journey with unforgettable memories.
                  </div>
                </div>
                <div class="wg-tags">
                  <div class="left">
                    <span class="text-body-3"> Tag: </span>
                    <div class="tag-list">
                  ...
                  <div class="right">
                    <span class="text-body-3"> Share: </span>
                    <ul class="social style-2">
                      <li class="social-icon fs-20">
                        <a href="#"><i class="icon-fb1"></i></a>
                      </li>
                      <li class="social-icon fs-20">
                      ...
                      <li class="social-icon fs-20">
                        <a href="#"><i class="icon-instagram21"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="wg-nex-pre">
                  <div class="pre nex-pre-content">
                    <a href="#" class="text text-body-3 fw-6"> Previous </a>
                    <h6 class="fw-6">
                      What You Need for an Unforgettable Outdoor Experience in
                      Any Season
                    </h6>
                  </div>
                  <div class="line"></div>
                  <div class="nex nex-pre-content">
                    <a href="#" class="text text-body-3 fw-6"> Next </a>
                    <h6 class="fw-6">
                      Top 10 Must-Visit Travel Destinations for Adventure
                      Seekers
                    </h6>
                  </div>
                </div>
              ...
              <div class="blog-comment tf-spacing-12">
                <div class="review">
                  <div class="top">
                    <h4 class="title fw-6">03 Comments</h4>
                      ...
                      <div class="review-item pt-20">
                        ...
                        <div class="review-content">
                          ...
                          <div class="text-review text-body-3">
                            ...
                            was very responsive and great to work with. I would
                            recommend him to anyone looking for a logo or
                            graphic design!
                          </div>
                ...
                <div class="comment" id="form-comment">
                  ...
                  >
                    <div class="col">
                      ...
                      <fieldset class="pb-20">
                        <label class="text-body-3 pb-3" for="email"
                          >Email</label
                        >
                        <input
                          type="email"
                    ...
                    <fieldset class="pb-20 check-box pl-3 gap-9">
                      ...
                      <label class="text-body-3" for="checkbox"
                        >Save your name, email for the next time review</label
                      >
                    </fieldset>
                    <fieldset class="pb-20">
                      <label for="review" class="text-body-3 pb-3"
                        >Review</label
                      >
                      <textarea
                        id="review"
              ...
              <div class="sidebar">
                <div class="wg-avatar">
                  <div class="avatar">
                    <div class="image">
                      <img
                        src="image/avata/avatar-4.jpg"
                        data-src="image/avata/avatar-4.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
                    <div class="avatar-top">
                      ...
                      <div class="follower caption-1">200 Follower</div>
                      <a href="#" class="tf-btn style-small style-boder"
                        >Follow Me</a
                      >
                    </div>
                  </div>
                  <div class="text text-body-2">
                    Themesflat (@themesflat) is a writer who draws. He’s the
                    Bestselling author of “Number of The Year”. Donec vitae
                    tortor efficitur, convallis lelobortis elit.
                  </div>
                </div>
                <div class="wg-relatest-post sidebar-content">
                  ...
                  <div class="blog-grid">
                    <div class="image hover-img">
                      <img
                        src="image/blog/relatest-post-1.jpg"
                        data-src="image/blog/relatest-post-1.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
                    <div class="tags-content pb-12">
                      ...
                      <div class="frame">
                        ...
                        <div class="text-body-3 text">Activities</div>
                      </div>
                    </div>
                    <h6 class="title">
                      <a href="#"
                        >The Ultimate Guide to Planning Your Perfect Tour From
                        Start to Finish</a
                      >
                    </h6>
                  </div>
                  <div class="relatest-list">
                    <div class="image hover-img">
                      <img
                        src="image/blog/relatest-list-1.jpg"
                        data-src="image/blog/relatest-list-1.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
                    <div class="relatest-list-content">
                      <div class="tags-content style-2">
                        <div class="frame">
                          <div class="text">By David</div>
                        </div>
                        <div class="line"></div>
                        <div class="frame">
                          <div class="text">Mountant</div>
                        </div>
                      </div>
                      <h6 class="title">
                        <a href="#">
                  ...
                  <div class="relatest-list">
                    <div class="image hover-img">
                      <img
                        src="image/blog/relatest-list-2.jpg"
                        data-src="image/blog/relatest-list-2.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
                  ...
                  <div class="relatest-list">
                    <div class="image hover-img">
                      <img
                        src="image/blog/relatest-list-3.jpg"
                        data-src="image/blog/relatest-list-3.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
                  ...
                  <div class="relatest-list">
                    <div class="image hover-img">
                      <img
                        src="image/blog/relatest-list-4.jpg"
                        data-src="image/blog/relatest-list-4.jpg"
                        alt=""
                        class="lazyload"
                      />
                    </div>
        ...
        <section class="section-new">
          <div class="tf-container">
            <div class="row">
              <div class="col-12">
                <div class="blog-new">
                  <div class="title fw-6">Blog and Travel Guides</div>
                  <div class="sub-title text-body-2">
                    Explore the World through Informative Articles and Personal
                    Stories
                  </div>
                </div>
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="blog-item hover-img">
                        <div class="image">
                          <img
                            src="image/blog/blog-item-1.jpg"
                            data-src="image/blog/blog-item-1.jpg"
                            alt=""
                            class="lazyload"
                          />
                          <a href="#" class="date style-2">
                            <span class="day fw-6"> 28 </span>
                        ...
                        <div class="blog-item-content">
                          ...
                          <h5 class="title fw-6 pb-12">
                            <a href="#"
                              >Tour Packages to Consider for Your Next
                              Vacation.</a
                            >
                          </h5>
                          <div class="text-body-3 text">
                            Explore a curated list of 10 extraordinary Glamping
                    ...
                    <div class="swiper-slide">
                      <div class="blog-item hover-img">
                        <div class="image">
                          <img
                            src="image/blog/blog-item-2.jpg"
                            data-src="image/blog/blog-item-2.jpg"
                            alt=""
                            class="lazyload"
                          />
                          <a href="#" class="date style-2">
                        ...
                        <div class="blog-item-content">
                          ...
                          <h5 class="title fw-6 pb-12">
                            <a href="#"
                              >Camping in Style Tips for a Comfortable and
                              Enjoyable Trip</a
                            >
                          </h5>
                          <div class="text-body-3 text">
                    ...
                    <div class="swiper-slide">
                      <div class="blog-item hover-img">
                        <div class="image">
                          <img
                            src="image/blog/blog-item-3.jpg"
                            data-src="image/blog/blog-item-3.jpg"
                            alt=""
                            class="lazyload"
                          />
                          <a href="#" class="date style-2">
                        ...
                        <div class="blog-item-content">
                          ...
                          <h5 class="title fw-6 pb-12">
                            <a href="#"
                              >Explore the World Travel Tips for Every Type of
                              Traveler</a
                            >
                          </h5>
                          <div class="text-body-3 text">
                ...
                <div class="bottom-slide">
                  <div class="swiper-pagination pagination-section-new"></div>
                </div>
              </div>
            </div>
          </div>
