@extends('layouts.app')
@section('title','Ogani | Tour Details')
              ...
              <div class="col-lg-8">
                <div class="section-tours-details-inner">
                    ...
                    <div class="wg-price">
                      <div class="price-left wow fadeInUp">
                        ...
                        <div class="price text-body-2">
                          Starting from:
                          <h5 class="fw-6">$354</h5>
                        </div>
                      </div>
                      <div
                        class="price-right wow fadeInUp"
                        data-wow-delay="0.1s"
                      >
                  ...
                  <div class="details-content">
                    <div class="details-item">
                      ...
                      <div class="item-content">
                        <p class="text text-body-2">Price:</p>
                    ...
                    <div class="details-item">
                      ...
                      <div class="item-content">
                        <p class="text text-body-2">Duration</p>
                    ...
                    <div class="details-item">
                      ...
                      <div class="item-content">
                        <p class="text text-body-2">Language</p>
                    ...
                    <div class="details-item">
                      ...
                      <div class="item-content">
                        <p class="text text-body-2">People:</p>
                        <h6 class="fw-6">22</h6>
                      </div>
                    </div>
                    <div class="details-item">
                      ...
                      <div class="item-content">
                        <p class="text text-body-2">Rating</p>
                  ...
                  <div class="wg-info details-content-2">
                    <h5 class="title fw-6">Projects description</h5>
                    <div class="text">
                      <div class="text-body-2 pb-8">
                        Embark on an unforgettable adventure as you explore
                        majestic rivers and waterways. Paddle through serene
                        landscapes, navigate winding rivers, and discover hidden
                        coves and secret beaches. This tour offers a unique
                        perspective on nature, allowing you to witness diverse
                        ecosystems, spot wildlife, and enjoy the tranquility of
                        being on the water. Whether you're an experienced
                        paddler or a beginner, our expert guides will ensure a
                        safe and enriching experience as you immerse yourself in
                        the beauty and wonder of these aquatic environments.
                      </div>
                      <div class="text-body-2">
                        As you journey through these pristine waterways, you'll
                        encounter breathtaking scenery and natural wonders at
                        every turn. Feel the rush of excitement as you paddle
                        past towering cliffs, lush forests, and vibrant
                        wetlands. Take a break to swim in crystal-clear waters,
                        relax on sandy riverbanks, or explore nearby trails and
                        viewpoints.
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="details-content-2">
                    <h5 class="title fw-6">Gallery</h5>
                    <div class="wg-gallery">
                      <div class="gallery-item gallery-item-1 hover-img">
                        <div class="image">
                          <img
                            src="image/gallery/gallery-1.jpg"
                            data-src="image/gallery/gallery-1.jpg"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                        <div class="gallery-content">
                          <a
                            href="../../../www.youtube.com/watch1de5.html?v=XHOmBV4js_E"
                            class="gallery-video popup-youtube"
                          >
                            <i class="icon-play-21"></i>
                          </a>
                          <div class="btn-gallery">
                            <a href="#" class="tf-btn"> View All Photo </a>
                          </div>
                        </div>
                      </div>
                      <div class="gallery-item gallery-item-2 hover-img">
                        <div class="image">
                          <img
                            src="image/gallery/gallery-2.jpg"
                            data-src="image/gallery/gallery-2.jpg"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      </div>
                      <div class="gallery-item gallery-item-3 hover-img">
                        <div class="image">
                          <img
                            src="image/gallery/gallery-3.jpg"
                            data-src="image/gallery/gallery-3.jpg"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      </div>
                      <div class="gallery-item gallery-item-4 hover-img">
                        <div class="image">
                          <img
                            src="image/gallery/gallery-4.jpg"
                            data-src="image/gallery/gallery-4.jpg"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                      </div>
                      <div class="gallery-item gallery-item-5 hover-img">
                        <div class="image">
                          <img
                            src="image/gallery/gallery-5.jpg"
                            data-src="image/gallery/gallery-5.jpg"
                            alt=""
                            class="lazyload"
                          />
                        </div>
                  ...
                  <div class="wg-not-included details-content-2">
                    <h5 class="title fw-6">Not included</h5>
                    <div class="services-list">
                      <div class="services-item text-body-2">
                        <img
                          src="icons/not-included.svg"
                          data-src="icons/not-included.svg"
                          alt=""
                          class="lazyload"
                        />
                        Additional Services
                  ...
                  <div class="line"></div>
                  <div class="wg-what-included details-content-2">
                    <h5 class="title fw-6">Tour Amenities</h5>
                  ...
                  <div class="line"></div>
                  <div class="details-content-2">
                    <h5 class="title fw-6">Tour Plan</h5>
                    <div class="tf-accordion" id="accordionOne">
                        ...
                        >
                          <div class="toggle-content-inner">
                            <div class="time-day">
                              ...
                              <ul>
                                <li class="text-body-2">
                                  Breakfast: Start your day with a hearty
                                  breakfast at your hotel.
                                </li>
                                <li class="text-body-2">
                                  Adventure Activity: Engage in an adventurous
                                  activity such as hiking, kayaking, or a guided
                                  wildlife tour.
                                </li>
                                <li class="text-body-2">
                                  Mid-Morning Snack: Enjoy a quick snack or
                                  coffee break.
                                </li>
                              </ul>
                            </div>
                            <div class="time-day">
                              ...
                              <ul>
                                <li class="text-body-2">
                                  Cultural Site Visit: Explore a significant
                                  cultural or historical site, such as a museum,
                                  temple, or castle.
                                </li>
                                <li class="text-body-2">
                                  Lunch: Savor a meal at a local eatery known
                                  for its traditional dishes.
                                </li>
                                <li class="text-body-2">
                                  Leisure Time: Spend some leisure time
                                  shopping, exploring local markets, or relaxing
                                  at a park.
                                </li>
                              </ul>
                            </div>
                            <div class="time-day">
                              ...
                              <ul>
                                <li class="text-body-2">
                                  Special Dinner Experience: Enjoy a special
                                  dining experience, such as a themed
                                  restaurant, a dinner cruise, or a food tour.
                                </li>
                                <li class="text-body-2">
                                  Nightlife Exploration: Discover the local
                                  nightlife by visiting a popular bar, club, or
                      ...
                      <div class="tf-accordion-item">
                        ...
                        <div
                          id="collapseTwo"
                          class="toggle-content collapse show"
                          data-bs-parent="#accordionOne"
                        >
                          <div class="toggle-content-inner">
                            <div class="time-day">
                  ...
                  <div class="line"></div>
                  <div class="details-content-2">
                    <h5 class="title fw-6">Calendar & Price</h5>
                    <div class="wg-calendar">
                      <div class="calendar-container">
                        <div class="calendar-header">
                          <a href="#" class="tf-btn-arrow prev">
                            <i class="icon-back1"></i
                          ></a>
                          <h6 class="title fw-6">
                            March <span class="fs-24 fw-4">2021</span>
                          </h6>
                          <a href="#" class="tf-btn-arrow next">
                  ...
                  <div class="line"></div>
                  <div class="details-content-2">
                    <h5 class="title fw-6">Where you’ll be</h5>
                    <div class="box-map3">
                      <div id="map3"></div>
                    </div>
                    <div class="desc">
                    ...
                    <div class="tf-accordion" id="accordionTwo">
                      <div class="tf-accordion-item">
                        <div class="text-body-2 title-accordion">
                          ...
                          >
                            What should I do if I lose my passport while
                            traveling?
                          </button>
                        </div>
                        <div
                        ...
                        >
                          <div class="toggle-content-inner">
                            <div class="text-body-2">
                              Yes, a passport is typically required for
                              international travel. It serves as your official
                              government-issued identification and is necessary
                              for entering and leaving a foreign country. It's
                              important to note that the requirements for
                              obtaining a passport can vary by country, so it's
                              best to research the specific requirements for
                              your destination well in advance of your trip.
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="blog-comment details-content-2">
                    <div class="review pb-0">
                      <div class="top">
                        <h5 class="title fw-6">Customers Reviews</h5>
                        <a href="#form-comment" class="tf-btn blog-search"
                          >Write A review</a
                        >
                      </div>
                      <div class="rate">
                    ...
                    <div class="comment-review loadmore-item3">
                      <div class="fl-item3">
                        <div class="review-item pt-20">
                          <div class="image">
                            <img
                              src="image/avata/avata-1.jpg"
                              data-src="image/avata/avata-1.jpg"
                              alt=""
                              class="lazyload"
                            />
                          </div>
                          <div class="review-content">
                            <div class="top-content">
                              <div class="name">
                                ...
                                <div class="date-review">August 13, 2024</div>
                              </div>
                              <div class="rating">
                                <i class="icon-star1"></i>
                                <i class="icon-star1"></i>
                            ...
                            <div class="text-review text-body-3">
                              I really like the logo that Gihan created, and he
                              was very responsive and great to work with. I
                            ...
                            <div class="image-review">
                              <div class="img hover-img">
                                <img
                                  src="image/blog/review-1.jpg"
                                  data-src="image/blog/review-1.jpg"
                                  alt=""
                                  class="lazyload"
                                />
                              </div>
                              <div class="img hover-img">
                                <img
                                  src="image/blog/review-2.jpg"
                                  data-src="image/blog/review-2.jpg"
                                  alt=""
                                  class="lazyload"
                                />
                              </div>
                              <div class="img hover-img">
                                <img
                                  src="image/blog/review-3.jpg"
                                  data-src="image/blog/review-3.jpg"
                                  alt=""
                                  class="lazyload"
                                />
                              </div>
                              <div class="img hover-img">
                                <img
                                  src="image/blog/review-4.jpg"
                                  data-src="image/blog/review-4.jpg"
                                  alt=""
                                  class="lazyload"
                                />
                              </div>
                              <div class="more text-body-3 fw-6">+12</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="fl-item3">
                        <div class="review-item">
                          <div class="image">
                            <img
                              src="image/avata/avata-2.jpg"
                              data-src="image/avata/avata-2.jpg"
                              alt=""
                              class="lazyload"
                            />
                          </div>
                      ...
                      <div class="fl-item3">
                        <div class="review-item">
                          <div class="image">
                            <img
                              src="image/avata/avata-3.jpg"
                              data-src="image/avata/avata-3.jpg"
                              alt=""
                              class="lazyload"
                            />
                          </div>
                    ...
                    <div class="bottom view-more-button3">
                      <a class="tf-btn style-border-bottom btn-loadmore3"
                        >View More</a
                      >
                    </div>
                    <div class="details-content-2" id="form-comment">
                      ...
                      <div class="choose-star">
                        <div class="item">
                          <div class="title caption-1">Location</div>
                          <div class="rating">
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                        ...
                        <div class="item">
                          <div class="title caption-1">Rooms</div>
                          <div class="rating">
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                        ...
                        <div class="item">
                          <div class="title caption-1">Services</div>
                          <div class="rating">
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                        ...
                        <div class="item">
                          <div class="title caption-1">Cleanliness</div>
                          <div class="rating">
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                        ...
                        <div class="item">
                          <div class="title caption-1">Value for money</div>
                          <div class="rating">
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                            <i class="icon-star1"></i>
                    ...
                    <form
                      action="https://themesflat.co/html/epictrips/@"
                      class="form-comment"
                    >
                      <div class="cols">
                        ...
                        <fieldset class="pb-20">
                          ...
                          <input
                            ...
                            id="email"
                            required=""
                            value="themeflat@gmail.com"
                          />
                        </fieldset>
                      </div>
                      <fieldset class="pb-20 check-box pl-3 gap-9">
                        <input type="checkbox" name="checkbox" id="checkbox" />
                        <label class="text-body-3 pb-0" for="checkbox"
                          >Save your name, email for the next time review</label
                        >
                      </fieldset>
                      <fieldset class="pb-20">
                      ...
                      <div class="btn-bottom">
                        <button type="submit" class="tf-btn color-primary">
                          Post Comment
                        </button>
                      </div>
                    </form>
                ...
                <div class="details-content-2">
                  <h5 class="title fw-6">You may like</h5>
                  <div class="row">
                    <div class="col-12">
                      <div class="grid-layout-2 style-2">
                        <div class="tour-grid hover-img">
                          <div class="image">
                            <img
                              src="image/tour-grid/tour-grid-2.jpg"
                              data-src="image/tour-grid/tour-grid-2.jpg"
                              alt=""
                              class="lazyload"
                            />
                            <div class="heart tf-action-btns"></div>
                            <a class="caption-2 tf-btn style-uppercase"
                              >Discovery</a
                            >
                            <span class="number caption-1"> 1/8 </span>
                          </div>
                          <div class="tour-grid-content">
                            ...
                            <div class="title text-body-2 fw-6 pb-8">
                              <a href="tours-details-1.html"
                                >Uncover Hidden Historical Wonders and
                                Secrets</a
                              >
                            </div>
                            ...
                            <div class="price text-body-3">
                              Starting from:
                              <span class="text-body-2 fw-6">$213</span>
                            </div>
                          </div>
                        </div>
                        <div class="tour-grid hover-img">
                          <div class="image">
                            <img
                              src="image/tour-grid/tour-grid-4.jpg"
                              data-src="image/tour-grid/tour-grid-4.jpg"
                              alt=""
                              class="lazyload"
                            />
                            <div class="heart tf-action-btns"></div>
                          ...
                          <div class="tour-grid-content">
                            ...
                            <div class="title text-body-2 fw-6 pb-8">
                              <a href="tours-details-1.html"
                                >Wild Adventures Under the Beautiful Starry
                                Sky</a
                              >
                            </div>
                            ...
                            <div class="price text-body-3">
                              Starting from:
                              <span class="text-body-2 fw-6">$92</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-lg-4">
                <div class="section-sidebar">
                  <div class="wg-booking mb-30">
                    <h5 class="title fw-6">Book Your Tour</h5>
                      ...
                      <div class="radio-box">
                        <fieldset>
                          <input
                            ...
                            checked
                          />
                          <label class="text-body-3" for="radio1"
                            >10:00 AM</label
                          >
                        </fieldset>
                        <fieldset>
                          <input type="radio" name="radio" id="radio2" />
                          <label class="text-body-3" for="radio2"
                            >12:00PM</label
                          >
                        </fieldset>
                      </div>
                    ...
                    <div class="booking-people wg-booking-content">
                      ...
                      <ul>
                        <li class="text-body-3">
                          ...
                          <div class="quantity">
                            <span
                              class="btn-quantity minus-btn minus-btn-1"
                            ></span>
                            <input
                              type="text"
                              name="number-adults"
                            ...
                            />
                            <span
                              class="btn-quantity plus-btn plus-btn-1"
                            ></span>
                          </div>
                        </li>
                        <li class="text-body-3">
                          <div class="text">
                            Children <span>(0-12 Years)</span>
                          </div>
                          <div class="quantity">
                            <span
                              class="btn-quantity minus-btn minus-btn-2"
                            ></span>
                            <input
                              type="text"
                              name="number-adults"
                              value="0"
                              id="number-children"
                              class="number-children fw-6"
                            />
                            <span
                              class="btn-quantity plus-btn plus-btn-2"
                            ></span>
                          </div>
                        </li>
                      </ul>
                    ...
                    <div class="wg-add-extra wg-booking-content">
                      <div
                        class="title-content fw-6 text-body-3 pb-1"
                        role="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseOne"
                        aria-expanded="false"
                      ...
                      <div
                        id="collapseOne"
                        class="tf-accordion-collapse collapse show"
                        ...
                        <div class="wg-add-extra-content">
                          <div class="service-per-booking">
                            ...
                            <div class="price text-body-3">
                              ...
                              <p class="text-body-3 fw-6">
                                <span>Adult:</span> $15.00
                              </p>
                            </div>
                          </div>
                          <div class="service-per-booking">
                            ...
                            <div class="price text-body-3">
                              <p class="text-body-3 fw-6 pb-8">
                                <span>Youth</span> $15.00
                              </p>
                              <p class="text-body-3 fw-6">
                                <span>Children:</span> $15.00
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="wg-total">
                      ...
                      <h5 class="price fw-6">$110</h5>
                    </div>
                    <a href="#" class="tf-btn color-primary text-center"
                      >Booking Now</a
                    >
                  </div>
                  <div class="wg-tour-info">
                    ...
                    <div class="wg-tour-info-content">
                      <div class="left text-body-3">Max Guest:</div>
                      <div class="right text-body-3 fw-6">40</div>
                    </div>
                    <div class="line"></div>
                    <div class="wg-tour-info-content">
                      <div class="left text-body-3">Min Age:</div>
                      <div class="right text-body-3 fw-6">10</div>
                    </div>
                    <div class="line"></div>
                    <div class="wg-tour-info-content">
                      <div class="left text-body-3">Location:</div>
                    ...
                    <div class="line"></div>
                    <div class="wg-tour-info-content">
                      <div class="left text-body-3">Contact:</div>
                      <div class="right text-body-3 fw-6">+123 456 7890</div>
                    </div>
                    <div class="line"></div>
                    <div class="wg-tour-info-content">
                      <div class="left text-body-3">Language Support:</div>
                      <div class="right text-body-3 fw-6">English & China</div>
                    </div>
                  </div>
                </div>
              </div>
