          ...
          <div class="row">
            <div class="col-lg-8">
                ...
                <div class="list-blog-content">
                  <div class="tags wow fadeInUp">
                    <div class="date-post tags-content">
                      ...
                      <div class="frame">
                        ...
                        <div class="text-body-3 text">Travel</div>
                      </div>
                    </div>
                  ...
                  <h4 class="title wow fadeInUp">
                    <a href="{{ route('blog-detail') }}"
                      ...
                      Seekers Who Crave Excitement and Thrills</a
                    >
                  </h4>
                  <div class="text text-body-2 wow fadeInUp">
                    June is Pride Month, a time to celebrate and support the
                    LGBTQ+ community. In this article, we explore how brands can
                    develop authentic Pride Month marketing strategies that
              ...
              <div class="list-blog hover-img tf-spacing-2">
                <div class="image wow fadeInUp">
                  <img
                    src="image/blog/blog-defaults-2.jpg"
                    data-src="image/blog/blog-defaults-2.jpg"
                    alt=""
                    class="lazyload"
                  />
                  <a href="#" class="date">
                ...
                <div class="list-blog-content">
                  <div class="tags wow fadeInUp">
                    <div class="date-post tags-content">
                      ...
                      <div class="frame">
                        ...
                        <div class="text-body-3 text">Mountant</div>
                      </div>
                    </div>
                    <div class="comment tags-content">
                      <div class="frame">
                  ...
                  <h4 class="title wow fadeInUp">
                    <a href="blog-post.html"
                      >Camping Essentials: What You Need for an Unforgettable
              ...
              <div class="list-blog hover-img">
                <div class="image wow fadeInUp">
                  <img
                    src="image/blog/blog-defaults-3.jpg"
                    data-src="image/blog/blog-defaults-3.jpg"
                    alt=""
                    class="lazyload"
                  />
                  <a href="#" class="date">
                ...
                <div class="list-blog-content">
                  <div class="tags wow fadeInUp">
                    <div class="date-post tags-content">
                      ...
                      <div class="frame">
                        ...
                        <div class="text-body-3 text">Sea</div>
                      </div>
                    </div>
                    <div class="comment tags-content">
                      <div class="frame">
                  ...
                  <h4 class="title wow fadeInUp">
                    <a href="blog-post.html"
                      >Tour Highlights: Discover the Best Sights and Experiences
              ...
              <div class="sidebar">
                ...
                <div class="wg-relatest-post sidebar-content">
                  ...
                  <div class="relatest-list hover-img">
                    ...
                    <div class="relatest-list-content">
                      ...
                      <h6 class="title">
                        <a href="#"> Explore the World Without Breaking </a>
                      </h6>
                    </div>
                  </div>
                  <div class="relatest-list hover-img">
                  ...
                  <div class="relatest-list hover-img">
                    ...
                    <div class="relatest-list-content">
                      ...
                      <h6 class="title">
                        <a href="#"> Benefits of Spending Time in Nature </a>
                      </h6>
                    </div>
                  </div>
                </div>
                <div class="wg-categories sidebar-content">
                  ...
                  <ul class="sidebar-categories-list">
                    <li class="item">
                      <a href="#" class="text-body-3">Camping</a>
                    </li>
                    <li class="item">
                      <a href="#" class="text-body-3">Tours</a>
                    </li>
                    <li class="item">
                      <a href="#" class="text-body-3">Travel</a>
                    </li>
                    <li class="item">
                      <a href="#" class="text-body-3">Mountant</a>
                    </li>
                    <li class="item">
                      <a href="#" class="text-body-3">Sea</a>
                    </li>
                  </ul>
                </div>
